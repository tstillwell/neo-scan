function loadData() {
		...
		$.ajax({
		  ...
		  for (var i = 0; i < $number_of_neos; i++) {
			   ...
			   $result_list_item += "<td>" + $neo.estimated_diameter.meters.estimated_diameter_min + " - ";
			   $result_list_item += $neo.estimated_diameter.meters.estimated_diameter_max + " meters </td>";
